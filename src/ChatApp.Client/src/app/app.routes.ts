...
export const routes: Routes = [
  ...
  { path: 'chat/:userId', loadChildren: () => import('@pages/chat').then(m => m.CHAT_ROUTES), canActivate: [authGuard] },
  { path: 'settings', loadChildren: () => import('@pages/settings').then(m => m.SETTINGS_ROUTES), canActivate: [authGuard] },
